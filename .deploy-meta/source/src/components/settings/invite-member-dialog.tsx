...
const ROLE_DESCRIPTIONS: Record<InviteRole, string> = {
  ...
  viewer: 'Acesso apenas leitura em todas as páginas. Não pode enviar ou editar nada.',
};
...
export function InviteMemberDialog({
  ...
  function whatsappShareUrl(url: string): string {
    ...
    const message = `Entre na equipe ${accountName} no wacrm usando este link (válido por ${result?.expiresInDays} dias): ${url}`;
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Compartilhe este link com seu novo colega de equipe. Ele poderá
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Nós nunca salvamos o link em texto limpo — assim que você fechar este diálogo
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                Slack ou qualquer canal que desejar — sem necessidade de serviço de e-mail.
              </DialogDescription>
            </DialogHeader>
