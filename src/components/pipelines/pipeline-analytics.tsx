    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          ...
          tooltip="Quantidade de todos os negócios neste funil que não estão marcados como Perdidos. Negócios ganhos ainda são incluídos."
        />
        <Metric
        ...
        <Metric
          ...
          tooltip="Receita esperada: valor de cada negócio aberto × a probabilidade de sua etapa. Primeira etapa ≈ 10%, as etapas progridem até 90%, Ganho = 100%. Negócios perdidos são excluídos."
        />
        <Metric
