            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  . Insira (or corrija) o PIN de 2 etapas abaixo e clique em
                  Salvar Configuração para tentar novamente.
                </>
              ) : (
                <>
                  Este número foi salvo antes de existir o rastreamento de registro,
                  ou o registro foi pulado. Insira o PIN de 2 etapas abaixo e clique
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Necessário apenas para receber mensagens <strong className="text-muted-foreground">de entrada</strong> para um número de <strong className="text-muted-foreground">produção</strong>. Defina-o em{' '}
                <strong className="text-muted-foreground">
                  Gerenciador de Negócios da Meta → Contas do WhatsApp → Números de telefone → Confirmação em duas etapas
                </strong>
                , e cole-o aqui para que o wacrm possa inscrever o número —
                caso contrário, a Meta direcionará os eventos de entrada para o aplicativo que o
                reivindicou por último.{' '}
                ...
                Deixar em branco também mantém o registro existente
                untouched.
              </p>
            </div>
          </CardContent>
