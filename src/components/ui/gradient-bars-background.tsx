...
const GradientBars: React.FC<GradientBarsProps> = ({
  numBars = 15,
  gradientFrom = 'var(--primary, rgb(255, 60, 0))',
            ...
            return (
              <div
                ...
                style={{
                  ...
                  // @ts-expect-error -- custom CSS variable in style object
...
export default function GradientBarsBackground({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-transparent via-background/40 to-background z-[1]" />
...
export { GradientBarsBackground, GradientBars };
