...
export function NodeConfigForm({
  ...
  switch (node.node_type) {
        ...
        <>
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              Interpole em perguntas subsequentes e notas de transbordo com{" "}
    ...
    case "handoff":
      return (
        <TextRow
          label="Nota interna (para o atendente que receber o atendimento)"
        ...
        <div>
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="tag">Contato tem marcador</SelectItem>
