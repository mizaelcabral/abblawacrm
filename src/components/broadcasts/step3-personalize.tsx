    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Mapeie as variáveis do modelo para campos de contato, campos personalizados ou
          valores estáticos.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card/50 p-4">
        <div className="mb-3 flex items-center gap-2">
          ...
          <p className="text-sm font-medium text-foreground">Visualização em Tempo Real</p>
      ...
      {unmappedKeys.length > 0 && (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-300">
          ...
          . Caso contrário, esses marcadores serão enviados à Meta como textos vazios.
        </div>
      )}
